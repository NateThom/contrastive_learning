...
if __name__=="__main__":
    ...
    if args.simclr == False:
        ...
        train_dataset = dataset.Att_Dataset(
            ...
            args.attr_label_path,
            args.attr_to_use,
            simclr_flag=args.simclr,
            transform=transforms.Compose(
                [
                    random_resized_crop.MyRandomResizedCrop((178, 218)),
                    random_hflip.MyRandomHFlip(),
                    random_blur.MyRandomBlur(15),
                    color_jitter.MyRandomColorJitter()
                 ]
            )
        )
